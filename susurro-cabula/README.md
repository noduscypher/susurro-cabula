...
A small, portable cheat-sheet for a Roland AIRA Compact rig — **T-8 + S-1 + P-6** into a VMX300 mixer and Alesis monitoring. Built for fast reading at the desk, not for show. Plain-text and NomadNet `.mu` (micron) versions included.

Uma cábula pequena e portátil para um setup Roland AIRA Compact — **T-8 + S-1 + P-6** ligado a um mixer VMX300 e monitorização Alesis. Feita para ler depressa na mesa, não para mostrar. Inclui versões em texto e em `.mu` (micron) para NomadNet.
